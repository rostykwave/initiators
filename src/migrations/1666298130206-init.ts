...
export class init1666298130206 implements MigrationInterface {
    name = 'init1666298130206'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "account" ("id" SERIAL NOT NULL, "approved" boolean NOT NULL DEFAULT false, "role" "public"."account_role_enum" NOT NULL DEFAULT 'User', "firstName" character varying NOT NULL DEFAULT '', "lastName" character varying NOT NULL DEFAULT '', "email" character varying NOT NULL, "password" character varying NOT NULL DEFAULT '', CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`);
