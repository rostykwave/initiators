...
export class init1665668857637 implements MigrationInterface {
    name = 'init1665668857637'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "room" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "floor" integer NOT NULL, "description" character varying NOT NULL, "maxPeople" integer NOT NULL, "minPeople" integer NOT NULL, "roomTypeId" integer, CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))`);
